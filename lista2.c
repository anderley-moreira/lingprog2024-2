...
int num = 0;
	...
	scanf("%d", &num);
	if (num  >= 20 && num  <= 50) {
		printf("%d é compreendido entre 20 e 50\n", num);
	} else {
		printf("%d não é compreendido entre 20 e 50\n", num);		
	}
}
...
int num = 0;
	...
	scanf("%d", &num);
	if (num  >= 18) {
		printf("Idade: %d - Cidadão maior de idade \n", num);
	} else {
		printf("Idade: %d - Cidadão menor de idade \n", num);		
	}		
}
